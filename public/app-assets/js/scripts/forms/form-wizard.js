...
$(function () {
  ...
  var bsStepper = document.querySelectorAll('.bs-stepper'),
    ...
    var modernVerticalWizardSec = document.querySelector('.modern-vertical-wizard-example2');
  ...
  // Modern Vertical Wizard second
  // --------------------------------------------------------------------
  if (typeof modernVerticalWizardSec !== undefined && modernVerticalWizardSec !== null) {
    var modernVerticalStepper = new Stepper(modernVerticalWizardSec, {
      linear: false
    });
    $(modernVerticalWizardSec)
      .find('.btn-next')
      .on('click', function () {
        modernVerticalStepper.next();
      });
