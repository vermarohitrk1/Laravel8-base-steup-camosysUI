    ...
    <nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center" data-nav="brand-center">
        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
				 ...
				 @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                   ...
                                   <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/caregiver_register') }}">Become Caregiver</a>
                                </li>
                            @endif
                        @else
				...
				<?php //echo 'subdomain'. Auth::user()->subdomain;  ?>
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder"> {{ Auth::user()->name }}</span><span class="user-status"> @foreach(Auth::user()->roles as $role)
                        {{$role->name}}
                        @endforeach</span></div><span class="avatar">
                        @if(Auth::user()->profile != null)
                             @if(Auth::user()->profile->profile_img != null)
                            <img class="round" src="/uploads/images/{{ Auth::user()->profile->profile_img }}" alt="avatar" height="40" width="40">
                            @else
                            <img class="round" src="{{ asset('/uploads/images/avatar.png') }}" alt="avatar" height="40" width="40" />
                            @endif
                            @endif
					...
					<a class="dropdown-item" href="app-todo.html"><i class="mr-50" data-feather="check-square"></i> Task</a><a class="dropdown-item" href="app-chat.html"><i class="mr-50" data-feather="message-square"></i> Chats</a>
                        <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ url('/admin/setting')}}"><i class="mr-50" data-feather="settings"></i> Settings</a><a class="dropdown-item" href="page-pricing.html"><i class="mr-50" data-feather="credit-card"></i> Pricing</a><a class="dropdown-item" href="page-faq.html"><i class="mr-50" data-feather="help-circle"></i> FAQ</a>
